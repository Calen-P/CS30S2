...
Program: Account.java         Last Date of this Revision: March 06, 2026

Purpose: Handles the transactions and sends back data to LocalBank.java
...
public class Account
{
    ...
    /**
     * Returns true when objects have matching account ids.
     * pre: none

...
public abstract class Account {
	 ...
	 */
	public Account(double bal, String fName, String lName, String s, String c, String p, String pCode)//include street, city, province or state, postal code or zip code
	{
		balance = bal;
		cust = new Customer(fName, lName, s, c, p, pCode);//this constructor should reflect the new additions above, street, city, province, postal code
